...
export default withSiteData(() => (
  <div className="home-page">
    ...
    <p className="intro">If that’s not cliché enough, I also love dogs (especially greyhounds), play bass in a rock & roll band, and ocassionaly enjoy a pint of the good stuff.</p>
    <Image cloudName="joshuar" publicId="Hilights" w_auto="true" cld-responsive="true" crop="scale" className="home-image" />
  </div>
))
